...
| 3 | Weak or no MFA enforcement on user accounts | Medium | High | Security Defaults disabled and replaced with Conditional Access policy requiring MFA for all users. Break-glass excluded. | IA-5 (Authenticator Management) | Screenshots 16 |
